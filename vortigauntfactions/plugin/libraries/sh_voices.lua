...
PLUGIN.voices:AddVortigaunt("Vortigaunt", "Honor", "It is an honor.", "vo/npc/vortigaunt/itishonor.wav")
PLUGIN.voices:AddVortigaunt("Vortigaunt", "Honored", "We are honored.", "vo/npc/vortigaunt/wehonored.wav")
PLUGIN.voices:AddVortigaunt("Vortigaunt", "Honor Is Ours", "The honor is ours.", "vo/npc/vortigaunt/honorours.wav")
